...
def threaded(client_socket, addr):
    ...
    print("Source : ",source)
    detect_api.api(model=model,stride=stride,names=names,pt=pt,imgsz=imgsz,save_dir=save_dir,HOST=HOST,PORT=PORT,view_img=True, source=source, save_txt=False)
